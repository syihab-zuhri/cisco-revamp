...
> Project: NetLab | Document ID: DOC-TASKS-001 | Version: 0.1.0 | Status: Draft
...
- [ ] `TASK-P0-002` [S] Restore/read visual reference and define DESIGN tokens. Owner: Design. Refs: DESIGN.md. Done when: audit evidence and contrast report exist.
- [ ] `TASK-P0-003` [M] Define P0 network scenario fixtures. Owner: Curriculum/Domain. Refs: FR-013..016. Done when: passed/failed packet scenarios are reviewed.
...
- [ ] `TASK-P0-007` [L] Implement pure topology/device/link model. Owner: Domain. Refs: FR-010..012. Done when: domain unit tests pass.
- [ ] `TASK-P0-008` [L] Implement deterministic connectivity, ping, and packet events. Owner: Domain. Refs: FR-013..016. Done when: golden scenarios pass.
- [ ] `TASK-P0-009` [M] Implement exercise evaluator and scoring states. Owner: Domain. Refs: FR-017..020. Done when: exhaustive fixture suite passes.
