...
|---|---|---|---|---|---|---|---|
| FR-001..004 | CLASSROOM_SESSION | API-CLASS-001..003 | class_session | host/join | P0-004,P0-005,P0-013 | TEST-CLASS-001; `lib/classroom/session.test.ts`, `lib/classroom/api.test.ts`, `lib/classroom/routes.test.ts` | Partially Covered (API foundation; UI/E2E pending) |
...
| FR-010..016 | NETWORK_SIMULATOR | simulator canvas | workspace | owner | P0-007,P0-008,P0-011,P0-012 | TEST-SIM-001..003; `lib/simulator/core.test.ts`, `lib/simulator/editor.test.ts` | Partially Covered (interactive workspace; packet projection pending) |
